        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" wire:click="complete_task({{ $task->id }})" @if(in_array($task->id, $completed_tasks)) checked @endif>
                        </td>
                        <td>
        ...
        <div class="card">
            <div class="card-body">
                ...
                @if($current_task->added_to_my_day_at)
                    <a href="#" wire:click.prevent="add_to_my_day({{ $current_task->id }})">{{ __('Remove from My Day') }}</a>
                @else
                    <a href="#" wire:click.prevent="add_to_my_day({{ $current_task->id }})">{{ __('Add to My Day') }}</a>
                @endif
            </div>
        </div>
